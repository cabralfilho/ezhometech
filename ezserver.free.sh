...
testing_url='http://raw.githubusercontent.com/cabralfilho/ezhometech/master/channel_definition.xml'
...
standard_url='http://raw.githubusercontent.com/cabralfilho/ezhometech/master/online.zip'
